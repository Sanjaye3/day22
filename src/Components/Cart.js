...
import "C:\\Users\\sanja\\OneDrive\\Desktop\\cart\\my-app\\src\\Components\\Cart.css";
...
function Cart({a,b,c,d,}){
    ...
    return(
            <div className="Cart">
                ...
                <div className="Upper">
                <p style={{fontSize:"35px",margin: "20px",color: "#BBBEC3"}}>450 x 300</p>
                ...
                <br/>
                <br/>
                <Button variant="contained" sx={{  border: "1px solid black",backgroundColor:"white",color:"black","&:hover":{backgroundColor:"black",color:"white"}}}>{a}</Button>
